...
//This game is created by yours trully Theo Tshabalala

ArrayList<Integer> x = new ArrayList<Integer>(),y = new ArrayList<Integer>();
int w=30, h=30, blocks=20,direction=1, foodx=15, foody = 15,fc1 = 255, fc2 =255, fc3 =255,speed=8;
...
void draw(){
  ...
  ellipse(foodx*blocks+10, foody*blocks+10,blocks,blocks); //foood
  textAlign(LEFT);
  textSize(25);
  fill(255);
  //text("THEO SNAKE GAME!!!");
